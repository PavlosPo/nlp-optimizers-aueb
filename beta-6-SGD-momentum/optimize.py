...
def main():
    ...
    if __name__ == "__main__":
        ...
        study = optuna.create_study(
            study_name=f'sgd_momentum_{dataset_task}_epochs_{train_epoch}_batch_{batch_size}_seed_{seed_num}', 
            storage=sqlite_url, 
            load_if_exists=True, 
        ...
        with open(f"sgd_momentum_best_params_{dataset_task}_epochs_{train_epoch}_batch_{batch_size}_seed_{seed_num}.txt", "w") as f:
